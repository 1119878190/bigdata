...
import com.study.bd.mapreduce.WordCountJob;
...
public class WordCountJobSeq {
    ...
    public static class MyMapper extends Mapper<Text, Text, Text, LongWritable> {
         ...
         */
        @Override
        protected void map(Text k1, Text v1, Mapper<Text, Text, Text, LongWritable>.Context context) throws IOException, InterruptedException {
